...
Source: "Input\_Patch\5_dolce_0216-full\*";        DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: Patch; Check: DolceInstalled
...
Source: "Input\_Patch\9_unhollowed-dolce_0216\*";  DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs; Components: Patch; Check: DolceInstalled
#endif
