...
Name: "Content\Hardmods";                      Description: "Hardmod pack 2023/12/23 (Numerous clothing and accessory mods. Can't be uninstalled!)"; Types: extra extra_en
...
Name: "FIX\HC_Fix_CraftWindow";                Description: "Fix_CraftWindow v1.0 (Enlarge some studio menus to show more items)"                  ; Types: full_en full extra extra_en
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Name: "Feature\HC_FXsettings";                 Description: "HC_FXsettings v1.1.1 (Edit Unity and Beautify post processing settings in HoneyCome through ConfigurationManager)"; Types: extra extra_en
...
Name: "Feature\HC_Hair";                       Description: "HC_Hair v0.0.1 (Make hair partially transparent when eyes are set to show on top of hair. Warning: Breaks with some modded hair!)"
...
Name: "MISC\RuntimeUnityEditor_BepInEx6_IL2CPP"; Description: "Runtime Unity Editor v5.2 (Debugging tool for applications made with Unity3D game engine (IL2CPP runtime))"; Types: full_en full extra extra_en
