...
; -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Name: "IllusionLaunchers";                     Description: "IllusionLaunchers_HoneyCome v3.4.0.0 (Custom game launcher)"                          ; Types: full_en full extra extra_en custom
...
Name: "Feature\HC_FixationalEyeMovement";      Description: "FixationalEyeMovement v1.0.0 (Makes eyes slightly move around to mimic eyes focusing on different things)"; Types: extra extra_en
